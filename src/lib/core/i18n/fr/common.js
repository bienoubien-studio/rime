export default {
	...
	api_key_dialog_text: 'Cette clé API ne sera affichée qu\'une seule fois et ne pourra pas être récupérée ultérieurement. Veuillez la copier et la stocker en lieu sûr sur votre serveur.',
	browse: 'parcourez',
	close: 'Fermer',
